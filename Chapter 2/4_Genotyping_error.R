setwd("~/R/R_stuff/Gentianella/Gentianella_project/Comparing_error_etc/")
library(vcfR)
library(adegenet)
...
popdata <- read.table("popmap_southcant_reps.txt", header = T)
...
SNP_errorstats <- SNP_error(SNPs, "Disco")
